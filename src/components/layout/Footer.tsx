        ...
        <div className="grid grid-cols-4 md:grid-cols-8 gap-6 items-center">
          {brandLogos.map((brand, index) => (
            <div key={index} className="flex justify-center">
              <img src={brand.url} alt={brand.alt} className="h-8 object-contain opacity-70 hover:opacity-100 transition-opacity" />
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-start gap-3 text-sm text-slate-300">
                ...
                <a href="mailto:megabyte@example.com" className="hover:text-primary">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-2.5 text-sm text-slate-300">
              ...
              <li><Link href="/new-products" className="hover:text-primary">New Products</Link></li>
              <li><Link href="/best-sales" className="hover:text-primary">Best Sales</Link></li>
              <li><Link href="/secure-payment" className="hover:text-primary">Secure Payment</Link></li>
          ...
          <div className="md:col-span-5">
            <h4 className="font-semibold text-white mb-4">Be the first to know it</h4>
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" className="bg-white/10 hover:bg-primary w-10 h-10 rounded-full flex items-center justify-center transition-colors">
